...
LOGS = logging.getLogger("سورس فـاسـتـر \n ")
...
async def verifyLoggerGroup():
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(            "جـروب تخزين الخاص", iqthon, Config.TG_BOT_USERNAME, descript        )
